...
**return_object:** `Option<bool>` — When `true`, the response includes the full bill object.
...
**export_format:** `Option<ExportFormat>` — Export format for file downloads. When specified, returns data as a file instead of JSON.
...
**customer_id:** `i64` — Payabli-generated customer ID. Maps to "Customer ID" column in the Payabli Portal.
...
**force_customer_creation:** `Option<ForceCustomerCreation>` — When `true`, the request creates a new customer record, regardless of whether customer identifiers match an existing customer. Defaults to `false`.
...
**ach_validation:** `Option<AchValidation>` — When `true`, enables real-time validation of ACH account and routing numbers. This is an add-on feature, contact Payabli for more information.
...
## Token
<details><summary><code>client.token.<a href="/src/api/resources/token/client.rs">create_server_side_token</a>(request: CreateServerSideTokenRequest) -> Result&lt;PayabliAccessTokenResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**state:** `Option<Option<String>>` — An optional opaque value echoed back in the response. Use it to correlate the request with its response.
...
**permissions:** `Option<Option<Vec<String>>>` — An optional array of permission IDs that scopes the token to a subset of the credential's granted permissions. When omitted, the token carries all permissions granted to the credential.
...
<details><summary><code>client.subscription.<a href="/src/api/resources/subscription/client.rs">new_subscription</a>(request: RequestSchedule, force_customer_creation: Option&lt;Option&lt;ForceCustomerCreation&gt;&gt;) -> Result&lt;AddSubscriptionResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**customer_data:** `Option<PayorDataRequest>` — Object describing the customer/payor.
...
**invoice_data:** `Option<BillData>` — Object describing an Invoice linked to the subscription.
...
**payment_method:** `Option<RequestSchedulePaymentMethod>` — Information about the payment method for the transaction. Required and recommended fields for each payment method type are described in each schema below.
...
**subscription_type:** `Option<SubscriptionType>` — Subscription type. Defaults to `Regular` when omitted. Can't be changed after the subscription is created. If you send it to the update endpoint, it's ignored.
...
## PaymentLink
<details><summary><code>client.payment_link.<a href="/src/api/resources/payment_link/client.rs">add_pay_link_from_invoice</a>(id_invoice: i64, request: PayLinkDataInvoice, amount_fixed: Option&lt;Option&lt;bool&gt;&gt;, mail_2: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;PayabliApiResponsePaymentLinks, ApiError&gt;</code></summary>
<dl>
<dd>
...
**payor:** `Option<PayorElement>` — Customer/Payor section of payment link page
...
**bill_page_data:** `Option<PaymentPageRequestBodyOut>` — Updated payment link page configuration.
...
**expiration_date:** `Option<String>` — New expiration date for the payment link. Must be a future date. If null and the link is expired, uses the default expiration from settings. Updating the expiration date reactivates an expired payment link to Active status.
...
**status:** `Option<PaymentLinkStatus>` — Updated status for the payment link.
...
**create_anonymous:** `Option<CreateAnonymous>` — When `true`, creates a saved method with no associated customer information. The token will be associated with customer information the first time it's used to make a payment. Defaults to `false`.
...
**temporary:** `Option<Temporary>` — Creates a temporary, one-time-use token for the payment method that expires in 12 hours. Defaults to `false`.
...
**new_parent_organization_id:** `i64` — The ID for the paypoint's new parent organization.
...
**notification_request:** `Option<NotificationRequest>` — Optional notification request object for a webhook
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client.rs">list_devices</a>(entry: Entry, export_format: Option&lt;Option&lt;ExportFormat&gt;&gt;, from_record: Option&lt;Option&lt;i64&gt;&gt;, limit_record: Option&lt;Option&lt;i64&gt;&gt;, parameters: Option&lt;Option&lt;std::collections::HashMap&lt;String, Option&lt;String&gt;&gt;&gt;&gt;, sort_by: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;QueryDeviceResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client.rs">list_devices_org</a>(org_id: i64, export_format: Option&lt;Option&lt;ExportFormat&gt;&gt;, from_record: Option&lt;Option&lt;i64&gt;&gt;, limit_record: Option&lt;Option&lt;i64&gt;&gt;, parameters: Option&lt;Option&lt;std::collections::HashMap&lt;String, Option&lt;String&gt;&gt;&gt;&gt;, sort_by: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;QueryDeviceResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**limit_record:** `Option<LimitRecord>` — Max number of records to return for the query. Use `0` or negative value to return all records. Defaults to 20.
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client.rs">list_vcards_transactions</a>(entry: Entry, from_record: Option&lt;Option&lt;i64&gt;&gt;, limit_record: Option&lt;Option&lt;i64&gt;&gt;, parameters: Option&lt;Option&lt;std::collections::HashMap&lt;String, Option&lt;String&gt;&gt;&gt;&gt;, sort_by: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;VCardTransactionQueryResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        .query
        .list_vcards_transactions(
            &Entry("8cfec329267".to_string()),
            &ListVcardsTransactionsQueryRequest {
                from_record: Some(0),
                limit_record: Some(20),
                sort_by: Some("desc(CreatedOn)".to_string()),
                ..Default::default()
            },
            None,
        )
...
<details><summary><code>client.query.<a href="/src/api/resources/query/client.rs">list_vcards_transactions_org</a>(org_id: i64, from_record: Option&lt;Option&lt;i64&gt;&gt;, limit_record: Option&lt;Option&lt;i64&gt;&gt;, parameters: Option&lt;Option&lt;std::collections::HashMap&lt;String, Option&lt;String&gt;&gt;&gt;&gt;, sort_by: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;VCardTransactionQueryResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
async fn main() {
    ...
    client
        .query
        .list_vcards_transactions_org(
            123,
            &ListVcardsTransactionsOrgQueryRequest {
                from_record: Some(0),
                limit_record: Some(20),
                sort_by: Some("desc(CreatedOn)".to_string()),
                ..Default::default()
...
## Notificationlogs
<details><summary><code>client.notificationlogs.<a href="/src/api/resources/notificationlogs/client.rs">search_notification_logs</a>(request: SearchNotificationLogsRequest, page_size: Option&lt;Option&lt;Pagesize&gt;&gt;, page: Option&lt;Option&lt;i64&gt;&gt;) -> Result&lt;Vec&lt;NotificationLog&gt;, ApiError&gt;</code></summary>
<dl>
<dd>
...
**page_size:** `Option<Pagesize>` — Number of records on each response page.
...
**template_id:** `f64` — The boarding template ID. You can find this at the end of the boarding template URL in the Payabli Portal. Example: `https://partner-sandbox.payabli.com/myorganization/boarding/edittemplate/80`. Here, the template ID is `80`.
...
**paypoint_id:** `String` — ID of the existing paypoint to link to this application.
...
**template_id:** `String` — ID of the boarding template to use for the new application.
...
**return_boarding_access_info_in_line:** `Option<bool>` — When `true`, returns the boarding access information directly in the response.
...
**on_create:** `Option<Vec<String>>` — Additional actions to trigger when the application is created. Currently only `submitApplication` is supported, which automatically submits the application on creation and skips the draft state.
...
<details><summary><code>client.organization.<a href="/src/api/resources/organization/client.rs">edit_organization</a>(org_id_path_param: i64, request: OrganizationData) -> Result&lt;EditOrganizationResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**org_id_path_param:** `i64` — The numeric identifier for organization, assigned by Payabli.
...
## Management
<details><summary><code>client.management.<a href="/src/api/resources/management/client.rs">verify_account_details</a>(entry: String, request: VerifyAccountDetailsRequest) -> Result&lt;VerifyAccountDetailsResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**account_type:** `Option<String>` — The type of bank account, such as `Checking` or `Savings`.
...
**country:** `Option<String>` — The ISO country code for the bank account, such as `US`.
...
**account_holder_type:** `Option<String>` — The type of account holder. Accepted values are `personal` or `business`. Required when bank authentication is enabled for the paypoint's organization.
...
**holder_name:** `Option<String>` — The name of the bank account holder. For personal accounts, provide the holder's full name (for example, `Jane Doe`); the value is split on the first space into first and last name. For business accounts, provide the legal business name. Required when bank authentication is enabled for the paypoint's organization.
...
**vendor_id:** `String` — ID of the vendor to enrich. Must be active and belong to the given entrypoint.
...
**scope:** `Option<Vec<String>>` — Enrichment stages to run. Valid values are `invoice_scan` and `web_search`. Stages run in order: invoice scan first, then web search. If the vendor becomes payout-ready after invoice scan, web search is skipped.
...
**invoice_file:** `Option<FileContent>` — PDF invoice file, Base64-encoded. Required when `scope` includes `invoice_scan`.
...
**bill_id:** `Option<String>` — Bill ID to associate with this enrichment request.
...
<details><summary><code>client.money_out.<a href="/src/api/resources/money_out/client.rs">reissue_out</a>(request: ReissueOutRequest, trans_id: Option&lt;String&gt;) -> Result&lt;ReissuePayoutResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
## PayoutSubscription
<details><summary><code>client.payout_subscription.<a href="/src/api/resources/payout_subscription/client.rs">create_payout_subscription</a>(request: RequestPayoutSchedule) -> Result&lt;AddPayoutSubscriptionResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**payment_details:** `Option<PayoutPaymentDetail>` — Object describing details of the payout.
...
**bill_data:** `Option<Vec<BillPayOutDataRequest>>` — Array of bills associated with the payout subscription. If omitted and `doNotCreateBills` isn't set to `true`, the system creates a bill automatically.
...
**schedule_details:** `Option<PayoutScheduleDetail>` — Object describing the schedule for the payout subscription.
...
## Billing
<details><summary><code>client.billing.<a href="/src/api/resources/billing/client.rs">list_profiles</a>(org_id: String, profile_name: Option&lt;Option&lt;String&gt;&gt;, profile_id: Option&lt;Option&lt;String&gt;&gt;, limit_record: Option&lt;Option&lt;String&gt;&gt;, from_record: Option&lt;Option&lt;String&gt;&gt;) -> Result&lt;BillingProfileQueryResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**org_id:** `String` — The organization's numeric identifier.
...
**profile_name:** `Option<String>` — Filter to profiles whose name contains this string.
...
**profile_id:** `Option<String>` — Filter to a single profile by its identifier.
...
**from_record:** `Option<String>` — Zero-based offset into the result set. Defaults to `0`.
...
<details><summary><code>client.billing.<a href="/src/api/resources/billing/client.rs">get_profile</a>(service_group: GetProfileBillingRequestServiceGroup, entity_type: GetProfileBillingRequestEntityType, entity_id: String) -> Result&lt;BillingProfileResponse, ApiError&gt;</code></summary>
<dl>
<dd>
...
**entity_id:** `String` — The numeric identifier of the entity.
