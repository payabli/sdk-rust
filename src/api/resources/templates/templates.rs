...
impl TemplatesClient {
    ...
    pub async fn delete_template(&self, template_id: f64, options: Option<RequestOptions>) -> Result<PayabliApiResponseTemplateId, ApiError> {
    ...
    ///
    /// JSON response from the API
    pub async fn getlink_template(&self, template_id: f64, ignore_empty: bool, options: Option<RequestOptions>) -> Result<BoardingLinkApiResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn get_template(&self, template_id: f64, options: Option<RequestOptions>) -> Result<TemplateQueryRecord, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn list_templates(&self, org_id: i64, request: &ListTemplatesQueryRequest, options: Option<RequestOptions>) -> Result<TemplateQueryResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
