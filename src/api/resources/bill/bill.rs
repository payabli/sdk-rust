...
impl BillClient {
    ...
    pub async fn add_bill(&self, entry: &String, request: &BillOutData, options: Option<RequestOptions>) -> Result<BillResponse, ApiError> {
    ...
    ///
    /// JSON response from the API
    pub async fn delete_attached_from_bill(&self, id_bill: i64, filename: &String, request: &DeleteAttachedFromBillQueryRequest, options: Option<RequestOptions>) -> Result<BillResponse, ApiError> {
        self.http_client.execute_request(
            Method::DELETE,
    ...
    ///
    /// JSON response from the API
    pub async fn delete_bill(&self, id_bill: i64, options: Option<RequestOptions>) -> Result<BillResponse, ApiError> {
        self.http_client.execute_request(
            Method::DELETE,
            &format!("Bill/{}", id_bill),
            None,
    ...
    ///
    /// JSON response from the API
    pub async fn edit_bill(&self, id_bill: i64, request: &BillOutData, options: Option<RequestOptions>) -> Result<EditBillResponse, ApiError> {
        self.http_client.execute_request(
            Method::PUT,
            &format!("Bill/{}", id_bill),
            Some(serde_json::to_value(request).unwrap_or_default()),
    ...
    ///
    /// JSON response from the API
    pub async fn get_attached_from_bill(&self, id_bill: i64, filename: &String, request: &GetAttachedFromBillQueryRequest, options: Option<RequestOptions>) -> Result<FileContent, ApiError> {
        self.http_client.execute_request(
            Method::GET,
            &format!("Bill/attachedFileFromBill/{}/{}", id_bill, filename),
            None,
    ...
    ///
    /// JSON response from the API
    pub async fn get_bill(&self, id_bill: i64, options: Option<RequestOptions>) -> Result<GetBillResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
            &format!("Bill/{}", id_bill),
            None,
    ...
    ///
    /// JSON response from the API
    pub async fn list_bills(&self, entry: &String, request: &ListBillsQueryRequest, options: Option<RequestOptions>) -> Result<BillQueryResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn list_bills_org(&self, org_id: i64, request: &ListBillsOrgQueryRequest, options: Option<RequestOptions>) -> Result<BillQueryResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn modify_approval_bill(&self, id_bill: i64, request: &Vec<String>, options: Option<RequestOptions>) -> Result<ModifyApprovalBillResponse, ApiError> {
        self.http_client.execute_request(
            Method::PUT,
    ...
    ///
    /// JSON response from the API
    pub async fn send_to_approval_bill(&self, id_bill: i64, request: &SendToApprovalBillRequest, options: Option<RequestOptions>) -> Result<BillResponse, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            &format!("Bill/approval/{}", id_bill),
            Some(serde_json::to_value(&request.body).unwrap_or_default()),
            QueryBuilder::new().bool("autocreateUser", request.autocreate_user.clone())
            .build(),
            options,
        ).await
    }
    ...
    ///
    /// JSON response from the API
    pub async fn set_approved_bill(&self, id_bill: i64, approved: &String, request: &SetApprovedBillQueryRequest, options: Option<RequestOptions>) -> Result<SetApprovedBillResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
