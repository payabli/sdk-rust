...
impl ChargeBacksClient {
    ...
    pub async fn add_response(&self, id: i64, request: &ResponseChargeBack, options: Option<RequestOptions>) -> Result<AddResponseResponse, ApiError> {
    ...
    ///
    /// JSON response from the API
    pub async fn get_chargeback(&self, id: i64, options: Option<RequestOptions>) -> Result<ChargebackQueryRecords, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// Text response
    pub async fn get_chargeback_attachment(&self, id: i64, file_name: &String, options: Option<RequestOptions>) -> Result<String, ApiError> {
        self.http_client.execute_request(
            Method::GET,
