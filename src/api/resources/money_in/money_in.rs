...
impl MoneyInClient {
    ...
    pub async fn authorize(&self, request: &AuthorizeRequest, options: Option<RequestOptions>) -> Result<AuthResponse, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            "MoneyIn/authorize",
            Some(serde_json::to_value(&request.body).unwrap_or_default()),
            QueryBuilder::new().serialize("forceCustomerCreation", request.force_customer_creation.clone())
            .build(),
            options,
        ).await
    }
    ...
    ///
    /// JSON response from the API
    pub async fn capture(&self, trans_id: &String, amount: f64, options: Option<RequestOptions>) -> Result<CaptureResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn capture_auth(&self, trans_id: &String, request: &CaptureRequest, options: Option<RequestOptions>) -> Result<CaptureResponse, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn credit(&self, request: &RequestCredit, options: Option<RequestOptions>) -> Result<PayabliApiResponse0, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            "MoneyIn/makecredit",
            Some(serde_json::to_value(request).unwrap_or_default()),
    ...
    ///
    /// JSON response from the API
    pub async fn details(&self, trans_id: &String, options: Option<RequestOptions>) -> Result<TransactionQueryRecordsCustomer, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn getpaid(&self, request: &GetpaidRequest, options: Option<RequestOptions>) -> Result<PayabliApiResponseGetPaid, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            "MoneyIn/getpaid",
            Some(serde_json::to_value(&request.body).unwrap_or_default()),
            QueryBuilder::new().serialize("achValidation", request.ach_validation.clone()).serialize("forceCustomerCreation", request.force_customer_creation.clone()).bool("includeDetails", request.include_details.clone())
            .build(),
            options,
        ).await
    }
    ...
    ///
    /// JSON response from the API
    pub async fn reverse(&self, trans_id: &String, amount: f64, options: Option<RequestOptions>) -> Result<ReverseResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn refund(&self, trans_id: &String, amount: f64, options: Option<RequestOptions>) -> Result<RefundResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn refund_with_instructions(&self, trans_id: &String, request: &RequestRefund, options: Option<RequestOptions>) -> Result<RefundWithInstructionsResponse, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn reverse_credit(&self, trans_id: &String, options: Option<RequestOptions>) -> Result<PayabliApiResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn send_receipt_2_trans(&self, trans_id: &String, request: &SendReceipt2TransQueryRequest, options: Option<RequestOptions>) -> Result<ReceiptResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
            &format!("MoneyIn/sendreceipt/{}", trans_id),
            None,
            QueryBuilder::new().string("email", request.email.clone())
            .build(),
            options,
        ).await
    }
    ...
    ///
    /// JSON response from the API
    pub async fn validate(&self, request: &RequestPaymentValidate, options: Option<RequestOptions>) -> Result<ValidateResponse, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            "MoneyIn/validate",
            Some(serde_json::to_value(request).unwrap_or_default()),
    ...
    ///
    /// JSON response from the API
    pub async fn void(&self, trans_id: &String, options: Option<RequestOptions>) -> Result<VoidResponse, ApiError> {
        self.http_client.execute_request(
            Method::GET,
    ...
    ///
    /// JSON response from the API
    pub async fn getpaidv_2(&self, request: &Getpaidv2Request, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
            "v2/MoneyIn/getpaid",
            Some(serde_json::to_value(&request.body).unwrap_or_default()),
            QueryBuilder::new().serialize("achValidation", request.ach_validation.clone()).serialize("forceCustomerCreation", request.force_customer_creation.clone())
            .build(),
            options,
        ).await
    }
    ...
    ///
    /// JSON response from the API
    pub async fn authorizev_2(&self, request: &Authorizev2Request, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn capturev_2(&self, trans_id: &String, request: &CaptureRequest, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn refundv_2(&self, trans_id: &String, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn refundv_2_amount(&self, trans_id: &String, amount: f64, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
    ...
    ///
    /// JSON response from the API
    pub async fn voidv_2(&self, trans_id: &String, options: Option<RequestOptions>) -> Result<V2TransactionResponseWrapper, ApiError> {
        self.http_client.execute_request(
            Method::POST,
