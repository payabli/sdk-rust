...
impl ListPayoutOrgQueryRequest {
    pub fn builder() -> ListPayoutOrgQueryRequestBuilder {
        <ListPayoutOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListPayoutOrgQueryRequestBuilder {
...
impl ListPayoutOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListPayoutOrgQueryRequest`].
    pub fn build(self) -> Result<ListPayoutOrgQueryRequest, BuildError> {
        Ok(ListPayoutOrgQueryRequest {
