...
/// Query parameters for ExportInvoices
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportInvoicesQueryRequest {
...
impl ExportInvoicesQueryRequest {
    pub fn builder() -> ExportInvoicesQueryRequestBuilder {
        <ExportInvoicesQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportInvoicesQueryRequestBuilder {
...
impl ExportInvoicesQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportInvoicesQueryRequest`].
    pub fn build(self) -> Result<ExportInvoicesQueryRequest, BuildError> {
        Ok(ExportInvoicesQueryRequest {
