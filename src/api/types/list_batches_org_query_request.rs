...
impl ListBatchesOrgQueryRequest {
    pub fn builder() -> ListBatchesOrgQueryRequestBuilder {
        <ListBatchesOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListBatchesOrgQueryRequestBuilder {
...
impl ListBatchesOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBatchesOrgQueryRequest`].
    pub fn build(self) -> Result<ListBatchesOrgQueryRequest, BuildError> {
        Ok(ListBatchesOrgQueryRequest {
