...
impl ValidateResponseData {
    pub fn builder() -> ValidateResponseDataBuilder {
        <ValidateResponseDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ValidateResponseDataBuilder {
...
impl ValidateResponseDataBuilder {
    ...
    /// Consumes the builder and constructs a [`ValidateResponseData`].
    /// This method will fail if any of the following fields are not set:
    /// - [`auth_code`](ValidateResponseDataBuilder::auth_code)
    /// - [`reference_id`](ValidateResponseDataBuilder::reference_id)
    /// - [`result_code`](ValidateResponseDataBuilder::result_code)
    /// - [`result_text`](ValidateResponseDataBuilder::result_text)
    /// - [`avs_response_text`](ValidateResponseDataBuilder::avs_response_text)
    /// - [`cvv_response_text`](ValidateResponseDataBuilder::cvv_response_text)
    /// - [`customer_id`](ValidateResponseDataBuilder::customer_id)
    pub fn build(self) -> Result<ValidateResponseData, BuildError> {
        Ok(ValidateResponseData {
            auth_code: self
                .auth_code
