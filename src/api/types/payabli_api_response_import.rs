...
pub struct PayabliApiResponseImport {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_data: Option<PayabliApiResponseImportResponseData>,
    #[serde(rename = "responseText")]
    #[serde(default)]
    pub response_text: ResponseText,
}

impl PayabliApiResponseImport {
    pub fn builder() -> PayabliApiResponseImportBuilder {
        <PayabliApiResponseImportBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PayabliApiResponseImportBuilder {
    is_success: Option<IsSuccess>,
    page_identifier: Option<PageIdentifier>,
    response_code: Option<Responsecode>,
    response_data: Option<PayabliApiResponseImportResponseData>,
    response_text: Option<ResponseText>,
}

impl PayabliApiResponseImportBuilder {
    ...
    pub fn response_data(mut self, value: PayabliApiResponseImportResponseData) -> Self {
    ...
    /// Consumes the builder and constructs a [`PayabliApiResponseImport`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](PayabliApiResponseImportBuilder::response_text)
    pub fn build(self) -> Result<PayabliApiResponseImport, BuildError> {
        Ok(PayabliApiResponseImport {
