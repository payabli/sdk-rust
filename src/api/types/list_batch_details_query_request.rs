...
/// Query parameters for ListBatchDetails
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListBatchDetailsQueryRequest {
...
impl ListBatchDetailsQueryRequest {
    pub fn builder() -> ListBatchDetailsQueryRequestBuilder {
        <ListBatchDetailsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListBatchDetailsQueryRequestBuilder {
...
impl ListBatchDetailsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBatchDetailsQueryRequest`].
    pub fn build(self) -> Result<ListBatchDetailsQueryRequest, BuildError> {
        Ok(ListBatchDetailsQueryRequest {
