...
impl PayabliApiResponseNotifications {
    pub fn builder() -> PayabliApiResponseNotificationsBuilder {
        <PayabliApiResponseNotificationsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PayabliApiResponseNotificationsBuilder {
    is_success: Option<IsSuccess>,
    page_identifier: Option<PageIdentifier>,
    response_code: Option<Responsecode>,
    response_data: Option<PayabliApiResponseNotificationsResponseData>,
    response_text: Option<ResponseText>,
}

impl PayabliApiResponseNotificationsBuilder {
    ...
    pub fn response_data(mut self, value: PayabliApiResponseNotificationsResponseData) -> Self {
    ...
    /// Consumes the builder and constructs a [`PayabliApiResponseNotifications`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](PayabliApiResponseNotificationsBuilder::response_text)
    pub fn build(self) -> Result<PayabliApiResponseNotifications, BuildError> {
        Ok(PayabliApiResponseNotifications {
