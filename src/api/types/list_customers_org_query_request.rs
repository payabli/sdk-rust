...
/// Query parameters for ListCustomersOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListCustomersOrgQueryRequest {
...
impl ListCustomersOrgQueryRequest {
    pub fn builder() -> ListCustomersOrgQueryRequestBuilder {
        <ListCustomersOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListCustomersOrgQueryRequestBuilder {
...
impl ListCustomersOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListCustomersOrgQueryRequest`].
    pub fn build(self) -> Result<ListCustomersOrgQueryRequest, BuildError> {
        Ok(ListCustomersOrgQueryRequest {
