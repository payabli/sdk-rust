...
/// Query parameters for ExportBatchDetails
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportBatchDetailsQueryRequest {
...
impl ExportBatchDetailsQueryRequest {
    pub fn builder() -> ExportBatchDetailsQueryRequestBuilder {
        <ExportBatchDetailsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportBatchDetailsQueryRequestBuilder {
...
impl ExportBatchDetailsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportBatchDetailsQueryRequest`].
    pub fn build(self) -> Result<ExportBatchDetailsQueryRequest, BuildError> {
        Ok(ExportBatchDetailsQueryRequest {
