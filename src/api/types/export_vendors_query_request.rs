...
/// Query parameters for ExportVendors
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportVendorsQueryRequest {
...
impl ExportVendorsQueryRequest {
    pub fn builder() -> ExportVendorsQueryRequestBuilder {
        <ExportVendorsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportVendorsQueryRequestBuilder {
...
impl ExportVendorsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportVendorsQueryRequest`].
    pub fn build(self) -> Result<ExportVendorsQueryRequest, BuildError> {
        Ok(ExportVendorsQueryRequest {
