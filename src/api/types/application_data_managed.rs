...
pub struct ApplicationDataManaged {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub contacts: Option<Vec<ApplicationDataManagedContactsItem>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ownership: Option<Vec<ApplicationDataManagedOwnershipItem>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ApplicationDataManaged {
    pub fn builder() -> ApplicationDataManagedBuilder {
        <ApplicationDataManagedBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ApplicationDataManagedBuilder {
    ...
    bzip: Option<Bzip>,
    contacts: Option<Vec<ApplicationDataManagedContactsItem>>,
    ...
    mzip: Option<Mzip>,
    org_id: Option<Orgid>,
    ownership: Option<Vec<ApplicationDataManagedOwnershipItem>>,
...
impl ApplicationDataManagedBuilder {
    ...
    pub fn contacts(mut self, value: Vec<ApplicationDataManagedContactsItem>) -> Self {
    ...
    pub fn ownership(mut self, value: Vec<ApplicationDataManagedOwnershipItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`ApplicationDataManaged`].
    /// This method will fail if any of the following fields are not set:
    /// - [`signer`](ApplicationDataManagedBuilder::signer)
    pub fn build(self) -> Result<ApplicationDataManaged, BuildError> {
        Ok(ApplicationDataManaged {
