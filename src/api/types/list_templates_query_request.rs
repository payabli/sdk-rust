...
/// Query parameters for ListTemplates
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListTemplatesQueryRequest {
...
impl ListTemplatesQueryRequest {
    pub fn builder() -> ListTemplatesQueryRequestBuilder {
        <ListTemplatesQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListTemplatesQueryRequestBuilder {
...
impl ListTemplatesQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTemplatesQueryRequest`].
    pub fn build(self) -> Result<ListTemplatesQueryRequest, BuildError> {
        Ok(ListTemplatesQueryRequest {
