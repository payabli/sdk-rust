...
impl PayabliApiResponseTemplateId {
    pub fn builder() -> PayabliApiResponseTemplateIdBuilder {
        <PayabliApiResponseTemplateIdBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PayabliApiResponseTemplateIdBuilder {
...
impl PayabliApiResponseTemplateIdBuilder {
    ...
    /// Consumes the builder and constructs a [`PayabliApiResponseTemplateId`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](PayabliApiResponseTemplateIdBuilder::response_text)
    pub fn build(self) -> Result<PayabliApiResponseTemplateId, BuildError> {
        Ok(PayabliApiResponseTemplateId {
