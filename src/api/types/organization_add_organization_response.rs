...
impl AddOrganizationResponse {
    pub fn builder() -> AddOrganizationResponseBuilder {
        <AddOrganizationResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AddOrganizationResponseBuilder {
    is_success: Option<IsSuccess>,
    response_data: Option<Responsedatanonobject>,
    response_text: Option<ResponseText>,
}

impl AddOrganizationResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`AddOrganizationResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](AddOrganizationResponseBuilder::response_text)
    pub fn build(self) -> Result<AddOrganizationResponse, BuildError> {
