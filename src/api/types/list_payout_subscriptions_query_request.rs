...
impl ListPayoutSubscriptionsQueryRequest {
    pub fn builder() -> ListPayoutSubscriptionsQueryRequestBuilder {
        <ListPayoutSubscriptionsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListPayoutSubscriptionsQueryRequestBuilder {
...
impl ListPayoutSubscriptionsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListPayoutSubscriptionsQueryRequest`].
    pub fn build(self) -> Result<ListPayoutSubscriptionsQueryRequest, BuildError> {
        Ok(ListPayoutSubscriptionsQueryRequest {
