...
impl ListNotificationsQueryRequest {
    pub fn builder() -> ListNotificationsQueryRequestBuilder {
        <ListNotificationsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListNotificationsQueryRequestBuilder {
...
impl ListNotificationsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListNotificationsQueryRequest`].
    pub fn build(self) -> Result<ListNotificationsQueryRequest, BuildError> {
        Ok(ListNotificationsQueryRequest {
