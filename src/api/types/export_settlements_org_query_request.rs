...
/// Query parameters for ExportSettlementsOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportSettlementsOrgQueryRequest {
...
impl ExportSettlementsOrgQueryRequest {
    pub fn builder() -> ExportSettlementsOrgQueryRequestBuilder {
        <ExportSettlementsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportSettlementsOrgQueryRequestBuilder {
...
impl ExportSettlementsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportSettlementsOrgQueryRequest`].
    pub fn build(self) -> Result<ExportSettlementsOrgQueryRequest, BuildError> {
        Ok(ExportSettlementsOrgQueryRequest {
