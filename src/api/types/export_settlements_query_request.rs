...
/// Query parameters for ExportSettlements
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportSettlementsQueryRequest {
...
impl ExportSettlementsQueryRequest {
    pub fn builder() -> ExportSettlementsQueryRequestBuilder {
        <ExportSettlementsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportSettlementsQueryRequestBuilder {
...
impl ExportSettlementsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportSettlementsQueryRequest`].
    pub fn build(self) -> Result<ExportSettlementsQueryRequest, BuildError> {
        Ok(ExportSettlementsQueryRequest {
