...
impl VCardGetResponseAssociatedVendorSummary {
    pub fn builder() -> VCardGetResponseAssociatedVendorSummaryBuilder {
        <VCardGetResponseAssociatedVendorSummaryBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct VCardGetResponseAssociatedVendorSummaryBuilder {
...
impl VCardGetResponseAssociatedVendorSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`VCardGetResponseAssociatedVendorSummary`].
    pub fn build(self) -> Result<VCardGetResponseAssociatedVendorSummary, BuildError> {
        Ok(VCardGetResponseAssociatedVendorSummary {
