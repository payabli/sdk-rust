...
impl NotificationQueryRecord {
    pub fn builder() -> NotificationQueryRecordBuilder {
        <NotificationQueryRecordBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct NotificationQueryRecordBuilder {
...
impl NotificationQueryRecordBuilder {
    ...
    /// Consumes the builder and constructs a [`NotificationQueryRecord`].
    pub fn build(self) -> Result<NotificationQueryRecord, BuildError> {
        Ok(NotificationQueryRecord {
