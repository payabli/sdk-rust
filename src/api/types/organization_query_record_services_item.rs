...
pub struct OrganizationQueryRecordServicesItem {
...
impl OrganizationQueryRecordServicesItem {
    pub fn builder() -> OrganizationQueryRecordServicesItemBuilder {
        <OrganizationQueryRecordServicesItemBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct OrganizationQueryRecordServicesItemBuilder {
...
impl OrganizationQueryRecordServicesItemBuilder {
    ...
    /// Consumes the builder and constructs a [`OrganizationQueryRecordServicesItem`].
    pub fn build(self) -> Result<OrganizationQueryRecordServicesItem, BuildError> {
        Ok(OrganizationQueryRecordServicesItem {
