...
impl PayorDataRequest {
    pub fn builder() -> PayorDataRequestBuilder {
        <PayorDataRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PayorDataRequestBuilder {
...
impl PayorDataRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`PayorDataRequest`].
    pub fn build(self) -> Result<PayorDataRequest, BuildError> {
        Ok(PayorDataRequest {
