...
/// Query parameters for ListPayout
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListPayoutQueryRequest {
...
impl ListPayoutQueryRequest {
    pub fn builder() -> ListPayoutQueryRequestBuilder {
        <ListPayoutQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListPayoutQueryRequestBuilder {
...
impl ListPayoutQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListPayoutQueryRequest`].
    pub fn build(self) -> Result<ListPayoutQueryRequest, BuildError> {
        Ok(ListPayoutQueryRequest {
