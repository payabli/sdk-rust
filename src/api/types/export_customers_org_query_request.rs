...
impl ExportCustomersOrgQueryRequest {
    pub fn builder() -> ExportCustomersOrgQueryRequestBuilder {
        <ExportCustomersOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportCustomersOrgQueryRequestBuilder {
...
impl ExportCustomersOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportCustomersOrgQueryRequest`].
    pub fn build(self) -> Result<ExportCustomersOrgQueryRequest, BuildError> {
        Ok(ExportCustomersOrgQueryRequest {
