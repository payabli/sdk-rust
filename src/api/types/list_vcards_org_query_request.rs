...
impl ListVcardsOrgQueryRequest {
    pub fn builder() -> ListVcardsOrgQueryRequestBuilder {
        <ListVcardsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListVcardsOrgQueryRequestBuilder {
...
impl ListVcardsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListVcardsOrgQueryRequest`].
    pub fn build(self) -> Result<ListVcardsOrgQueryRequest, BuildError> {
        Ok(ListVcardsOrgQueryRequest {
