...
/// Query parameters for ListNotificationReports
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListNotificationReportsQueryRequest {
...
impl ListNotificationReportsQueryRequest {
    pub fn builder() -> ListNotificationReportsQueryRequestBuilder {
        <ListNotificationReportsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListNotificationReportsQueryRequestBuilder {
...
impl ListNotificationReportsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListNotificationReportsQueryRequest`].
    pub fn build(self) -> Result<ListNotificationReportsQueryRequest, BuildError> {
        Ok(ListNotificationReportsQueryRequest {
