...
/// Query parameters for ListChargebacks
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListChargebacksQueryRequest {
...
impl ListChargebacksQueryRequest {
    pub fn builder() -> ListChargebacksQueryRequestBuilder {
        <ListChargebacksQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListChargebacksQueryRequestBuilder {
...
impl ListChargebacksQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListChargebacksQueryRequest`].
    pub fn build(self) -> Result<ListChargebacksQueryRequest, BuildError> {
        Ok(ListChargebacksQueryRequest {
