...
impl GetEntryConfigResponse {
    pub fn builder() -> GetEntryConfigResponseBuilder {
        <GetEntryConfigResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetEntryConfigResponseBuilder {
...
impl GetEntryConfigResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetEntryConfigResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`is_success`](GetEntryConfigResponseBuilder::is_success)
    /// - [`response_text`](GetEntryConfigResponseBuilder::response_text)
    pub fn build(self) -> Result<GetEntryConfigResponse, BuildError> {
        Ok(GetEntryConfigResponse {
            is_success: self
                .is_success
