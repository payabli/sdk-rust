...
/// Query parameters for ListTransfersOutPaypoint
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListTransfersOutPaypointQueryRequest {
...
impl ListTransfersOutPaypointQueryRequest {
    pub fn builder() -> ListTransfersOutPaypointQueryRequestBuilder {
        <ListTransfersOutPaypointQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListTransfersOutPaypointQueryRequestBuilder {
...
impl ListTransfersOutPaypointQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTransfersOutPaypointQueryRequest`].
    pub fn build(self) -> Result<ListTransfersOutPaypointQueryRequest, BuildError> {
        Ok(ListTransfersOutPaypointQueryRequest {
