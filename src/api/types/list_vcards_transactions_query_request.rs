...
/// Query parameters for ListVcardsTransactions
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListVcardsTransactionsQueryRequest {
...
impl ListVcardsTransactionsQueryRequest {
    pub fn builder() -> ListVcardsTransactionsQueryRequestBuilder {
        <ListVcardsTransactionsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListVcardsTransactionsQueryRequestBuilder {
...
impl ListVcardsTransactionsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListVcardsTransactionsQueryRequest`].
    pub fn build(self) -> Result<ListVcardsTransactionsQueryRequest, BuildError> {
        Ok(ListVcardsTransactionsQueryRequest {
