...
pub struct RequestPayoutSchedule {
...
impl RequestPayoutSchedule {
    pub fn builder() -> RequestPayoutScheduleBuilder {
        <RequestPayoutScheduleBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RequestPayoutScheduleBuilder {
...
impl RequestPayoutScheduleBuilder {
    ...
    /// Consumes the builder and constructs a [`RequestPayoutSchedule`].
    /// This method will fail if any of the following fields are not set:
    /// - [`entry_point`](RequestPayoutScheduleBuilder::entry_point)
    /// - [`payment_method`](RequestPayoutScheduleBuilder::payment_method)
    /// - [`vendor_data`](RequestPayoutScheduleBuilder::vendor_data)
    pub fn build(self) -> Result<RequestPayoutSchedule, BuildError> {
        Ok(RequestPayoutSchedule {
            entry_point: self
                .entry_point
