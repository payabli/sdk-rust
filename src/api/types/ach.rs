...
impl Ach {
    pub fn builder() -> AchBuilder {
        <AchBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct AchBuilder {
...
impl AchBuilder {
    ...
    /// Consumes the builder and constructs a [`Ach`].
    /// This method will fail if any of the following fields are not set:
    /// - [`ach_account`](AchBuilder::ach_account)
    /// - [`ach_holder`](AchBuilder::ach_holder)
    /// - [`ach_routing`](AchBuilder::ach_routing)
    /// - [`method`](AchBuilder::method)
    pub fn build(self) -> Result<Ach, BuildError> {
        Ok(Ach {
            ach_account: self
                .ach_account
