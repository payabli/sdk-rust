...
impl SignerData {
    pub fn builder() -> SignerDataBuilder {
        <SignerDataBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SignerDataBuilder {
    ...
    signed_document_reference: Option<String>,
...
impl SignerDataBuilder {
    pub fn signer_uuid(mut self, value: impl Into<String>) -> Self {
        self.signer_uuid = Some(value.into());
        self
    }
    ...
    pub fn signed_document_reference(mut self, value: impl Into<String>) -> Self {
        self.signed_document_reference = Some(value.into());
        self
    }
    ...
    /// Consumes the builder and constructs a [`SignerData`].
    pub fn build(self) -> Result<SignerData, BuildError> {
        Ok(SignerData {
