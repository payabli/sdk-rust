...
impl ListBillsQueryRequest {
    pub fn builder() -> ListBillsQueryRequestBuilder {
        <ListBillsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListBillsQueryRequestBuilder {
...
impl ListBillsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBillsQueryRequest`].
    pub fn build(self) -> Result<ListBillsQueryRequest, BuildError> {
        Ok(ListBillsQueryRequest {
