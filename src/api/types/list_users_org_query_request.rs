...
/// Query parameters for ListUsersOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListUsersOrgQueryRequest {
...
impl ListUsersOrgQueryRequest {
    pub fn builder() -> ListUsersOrgQueryRequestBuilder {
        <ListUsersOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListUsersOrgQueryRequestBuilder {
...
impl ListUsersOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListUsersOrgQueryRequest`].
    pub fn build(self) -> Result<ListUsersOrgQueryRequest, BuildError> {
        Ok(ListUsersOrgQueryRequest {
