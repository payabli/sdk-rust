...
pub struct ApplicationDetailsRecord {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub messages: Option<Vec<ApplicationDetailsRecordMessagesItem>>,
    #[serde(rename = "mState")]
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ApplicationDetailsRecord {
    pub fn builder() -> ApplicationDetailsRecordBuilder {
        <ApplicationDetailsRecordBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ApplicationDetailsRecordBuilder {
    ...
    messages: Option<Vec<ApplicationDetailsRecordMessagesItem>>,
...
impl ApplicationDetailsRecordBuilder {
    ...
    pub fn messages(mut self, value: Vec<ApplicationDetailsRecordMessagesItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`ApplicationDetailsRecord`].
    pub fn build(self) -> Result<ApplicationDetailsRecord, BuildError> {
        Ok(ApplicationDetailsRecord {
