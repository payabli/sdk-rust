...
/// Query parameters for ListSettlements
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListSettlementsQueryRequest {
...
impl ListSettlementsQueryRequest {
    pub fn builder() -> ListSettlementsQueryRequestBuilder {
        <ListSettlementsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListSettlementsQueryRequestBuilder {
...
impl ListSettlementsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListSettlementsQueryRequest`].
    pub fn build(self) -> Result<ListSettlementsQueryRequest, BuildError> {
        Ok(ListSettlementsQueryRequest {
