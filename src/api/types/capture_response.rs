...
pub struct CaptureResponse {
    ...
    #[serde(default)]
    pub response_data: CaptureResponseData,
}

impl CaptureResponse {
    pub fn builder() -> CaptureResponseBuilder {
        <CaptureResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CaptureResponseBuilder {
    ...
    response_data: Option<CaptureResponseData>,
}

impl CaptureResponseBuilder {
    ...
    pub fn response_data(mut self, value: CaptureResponseData) -> Self {
        self.response_data = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CaptureResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_code`](CaptureResponseBuilder::response_code)
    /// - [`room_id`](CaptureResponseBuilder::room_id)
    /// - [`is_success`](CaptureResponseBuilder::is_success)
    /// - [`response_text`](CaptureResponseBuilder::response_text)
    /// - [`response_data`](CaptureResponseBuilder::response_data)
    pub fn build(self) -> Result<CaptureResponse, BuildError> {
        Ok(CaptureResponse {
            response_code: self
                .response_code
