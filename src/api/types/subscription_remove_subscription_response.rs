...
impl RemoveSubscriptionResponse {
    pub fn builder() -> RemoveSubscriptionResponseBuilder {
        <RemoveSubscriptionResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RemoveSubscriptionResponseBuilder {
    is_success: Option<IsSuccess>,
    response_data: Option<String>,
    response_text: Option<ResponseText>,
}

impl RemoveSubscriptionResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`RemoveSubscriptionResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](RemoveSubscriptionResponseBuilder::response_text)
    pub fn build(self) -> Result<RemoveSubscriptionResponse, BuildError> {
        Ok(RemoveSubscriptionResponse {
