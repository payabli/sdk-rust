...
/// Query parameters for ListDevicesOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListDevicesOrgQueryRequest {
...
impl ListDevicesOrgQueryRequest {
    pub fn builder() -> ListDevicesOrgQueryRequestBuilder {
        <ListDevicesOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListDevicesOrgQueryRequestBuilder {
...
impl ListDevicesOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListDevicesOrgQueryRequest`].
    pub fn build(self) -> Result<ListDevicesOrgQueryRequest, BuildError> {
        Ok(ListDevicesOrgQueryRequest {
