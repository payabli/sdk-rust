...
pub struct DeviceChallengeResponse {
    ...
    #[serde(default)]
    pub response_data: DeviceChallengeData,
}

impl DeviceChallengeResponse {
    pub fn builder() -> DeviceChallengeResponseBuilder {
        <DeviceChallengeResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct DeviceChallengeResponseBuilder {
    ...
    response_data: Option<DeviceChallengeData>,
}

impl DeviceChallengeResponseBuilder {
    ...
    pub fn response_data(mut self, value: DeviceChallengeData) -> Self {
        self.response_data = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`DeviceChallengeResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](DeviceChallengeResponseBuilder::response_text)
    /// - [`response_data`](DeviceChallengeResponseBuilder::response_data)
    pub fn build(self) -> Result<DeviceChallengeResponse, BuildError> {
