...
impl CaptureAllOutResponse {
    pub fn builder() -> CaptureAllOutResponseBuilder {
        <CaptureAllOutResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CaptureAllOutResponseBuilder {
    is_success: Option<IsSuccess>,
    page_identifier: Option<PageIdentifier>,
    response_code: Option<Responsecode>,
    response_data: Option<Vec<CaptureAllOutResponseResponseDataItem>>,
    response_text: Option<ResponseText>,
}

impl CaptureAllOutResponseBuilder {
    ...
    pub fn response_data(mut self, value: Vec<CaptureAllOutResponseResponseDataItem>) -> Self {
    ...
    /// Consumes the builder and constructs a [`CaptureAllOutResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](CaptureAllOutResponseBuilder::response_text)
    pub fn build(self) -> Result<CaptureAllOutResponse, BuildError> {
        Ok(CaptureAllOutResponse {
