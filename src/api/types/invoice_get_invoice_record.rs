...
impl GetInvoiceRecord {
    pub fn builder() -> GetInvoiceRecordBuilder {
        <GetInvoiceRecordBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetInvoiceRecordBuilder {
    ...
    invoice_sent_date: Option<DateTime<Utc>>,
...
impl GetInvoiceRecordBuilder {
    ...
    pub fn invoice_sent_date(mut self, value: DateTime<Utc>) -> Self {
    ...
    /// Consumes the builder and constructs a [`GetInvoiceRecord`].
    /// This method will fail if any of the following fields are not set:
    /// - [`invoice_id`](GetInvoiceRecordBuilder::invoice_id)
    /// - [`customer_id`](GetInvoiceRecordBuilder::customer_id)
    /// - [`paypoint_id`](GetInvoiceRecordBuilder::paypoint_id)
    /// - [`invoice_number`](GetInvoiceRecordBuilder::invoice_number)
    /// - [`created_at`](GetInvoiceRecordBuilder::created_at)
    /// - [`invoice_status`](GetInvoiceRecordBuilder::invoice_status)
    /// - [`invoice_type`](GetInvoiceRecordBuilder::invoice_type)
    /// - [`frequency`](GetInvoiceRecordBuilder::frequency)
    /// - [`payment_terms`](GetInvoiceRecordBuilder::payment_terms)
    /// - [`invoice_amount`](GetInvoiceRecordBuilder::invoice_amount)
    /// - [`invoice_paid_amount`](GetInvoiceRecordBuilder::invoice_paid_amount)
    /// - [`purchase_order`](GetInvoiceRecordBuilder::purchase_order)
    /// - [`shipping_address_1`](GetInvoiceRecordBuilder::shipping_address_1)
    /// - [`shipping_address_2`](GetInvoiceRecordBuilder::shipping_address_2)
    /// - [`shipping_city`](GetInvoiceRecordBuilder::shipping_city)
    /// - [`shipping_state`](GetInvoiceRecordBuilder::shipping_state)
    /// - [`shipping_zip`](GetInvoiceRecordBuilder::shipping_zip)
    /// - [`shipping_from_zip`](GetInvoiceRecordBuilder::shipping_from_zip)
    /// - [`shipping_country`](GetInvoiceRecordBuilder::shipping_country)
    /// - [`shipping_email`](GetInvoiceRecordBuilder::shipping_email)
    /// - [`shipping_phone`](GetInvoiceRecordBuilder::shipping_phone)
    /// - [`summary_commodity_code`](GetInvoiceRecordBuilder::summary_commodity_code)
    /// - [`items`](GetInvoiceRecordBuilder::items)
    /// - [`customer`](GetInvoiceRecordBuilder::customer)
    /// - [`paylink_id`](GetInvoiceRecordBuilder::paylink_id)
    /// - [`scheduled_options`](GetInvoiceRecordBuilder::scheduled_options)
    /// - [`paypoint_legalname`](GetInvoiceRecordBuilder::paypoint_legalname)
    /// - [`paypoint_dbaname`](GetInvoiceRecordBuilder::paypoint_dbaname)
    /// - [`paypoint_entryname`](GetInvoiceRecordBuilder::paypoint_entryname)
    /// - [`parent_org_name`](GetInvoiceRecordBuilder::parent_org_name)
    /// - [`documents_ref`](GetInvoiceRecordBuilder::documents_ref)
    pub fn build(self) -> Result<GetInvoiceRecord, BuildError> {
        Ok(GetInvoiceRecord {
            invoice_id: self
                .invoice_id
            ...
            purchase_order: self
                .purchase_order
                .ok_or_else(|| BuildError::missing_field("purchase_order"))?,
            ...
            summary_commodity_code: self
                .summary_commodity_code
                .ok_or_else(|| BuildError::missing_field("summary_commodity_code"))?,
            items: self
                .items
            ...
            scheduled_options: self
                .scheduled_options
                .ok_or_else(|| BuildError::missing_field("scheduled_options"))?,
            ...
            documents_ref: self
                .documents_ref
                .ok_or_else(|| BuildError::missing_field("documents_ref"))?,
