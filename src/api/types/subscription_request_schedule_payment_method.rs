...
impl RequestSchedulePaymentMethod {
    ...
    pub fn as_requestschedulepaymentmethodinitiator(&self) -> Option<&RequestSchedulePaymentMethodInitiator> {
        match self {
    ...
    pub fn into_requestschedulepaymentmethodinitiator(self) -> Option<RequestSchedulePaymentMethodInitiator> {
        match self {
                    Self::RequestSchedulePaymentMethodInitiator(value) => Some(value),
                    _ => None,
                }
...
impl fmt::Display for RequestSchedulePaymentMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::RequestSchedulePaymentMethodInitiator(value) => write!(f, "{}", serde_json::to_string(value).unwrap_or_else(|_| format!("{:?}", value))),
        }
    }
}
