...
pub struct SetApprovedBillResponse {
    #[serde(flatten)]
...
impl SetApprovedBillResponse {
    pub fn builder() -> SetApprovedBillResponseBuilder {
        <SetApprovedBillResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct SetApprovedBillResponseBuilder {
    payabli_api_response_generic_2_part_fields: Option<PayabliApiResponseGeneric2Part>,
    response_data: Option<i64>,
}

impl SetApprovedBillResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`SetApprovedBillResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`payabli_api_response_generic_2_part_fields`](SetApprovedBillResponseBuilder::payabli_api_response_generic_2_part_fields)
    pub fn build(self) -> Result<SetApprovedBillResponse, BuildError> {
        Ok(SetApprovedBillResponse {
