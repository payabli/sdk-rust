...
/// Query parameters for ListInvoicesOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListInvoicesOrgQueryRequest {
...
impl ListInvoicesOrgQueryRequest {
    pub fn builder() -> ListInvoicesOrgQueryRequestBuilder {
        <ListInvoicesOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListInvoicesOrgQueryRequestBuilder {
...
impl ListInvoicesOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListInvoicesOrgQueryRequest`].
    pub fn build(self) -> Result<ListInvoicesOrgQueryRequest, BuildError> {
        Ok(ListInvoicesOrgQueryRequest {
