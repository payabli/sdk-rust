...
pub struct RequestCreditPaymentMethod {
    ...
    pub method: RequestCreditPaymentMethodMethod,
}
...
pub struct RequestCreditPaymentMethodBuilder {
    ...
    method: Option<RequestCreditPaymentMethodMethod>,
}
...
impl RequestCreditPaymentMethodBuilder {
    ...
    pub fn method(mut self, value: RequestCreditPaymentMethodMethod) -> Self {
