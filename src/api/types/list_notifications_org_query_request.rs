...
/// Query parameters for ListNotificationsOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListNotificationsOrgQueryRequest {
...
impl ListNotificationsOrgQueryRequest {
    pub fn builder() -> ListNotificationsOrgQueryRequestBuilder {
        <ListNotificationsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListNotificationsOrgQueryRequestBuilder {
...
impl ListNotificationsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListNotificationsOrgQueryRequest`].
    pub fn build(self) -> Result<ListNotificationsOrgQueryRequest, BuildError> {
        Ok(ListNotificationsOrgQueryRequest {
