...
/// Query parameters for ExportTransactions
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportTransactionsQueryRequest {
...
impl ExportTransactionsQueryRequest {
    pub fn builder() -> ExportTransactionsQueryRequestBuilder {
        <ExportTransactionsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportTransactionsQueryRequestBuilder {
...
impl ExportTransactionsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportTransactionsQueryRequest`].
    pub fn build(self) -> Result<ExportTransactionsQueryRequest, BuildError> {
        Ok(ExportTransactionsQueryRequest {
