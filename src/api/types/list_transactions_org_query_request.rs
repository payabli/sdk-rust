...
impl ListTransactionsOrgQueryRequest {
    pub fn builder() -> ListTransactionsOrgQueryRequestBuilder {
        <ListTransactionsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListTransactionsOrgQueryRequestBuilder {
...
impl ListTransactionsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTransactionsOrgQueryRequest`].
    pub fn build(self) -> Result<ListTransactionsOrgQueryRequest, BuildError> {
        Ok(ListTransactionsOrgQueryRequest {
