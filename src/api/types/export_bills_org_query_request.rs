...
/// Query parameters for ExportBillsOrg
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportBillsOrgQueryRequest {
...
impl ExportBillsOrgQueryRequest {
    pub fn builder() -> ExportBillsOrgQueryRequestBuilder {
        <ExportBillsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportBillsOrgQueryRequestBuilder {
...
impl ExportBillsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportBillsOrgQueryRequest`].
    pub fn build(self) -> Result<ExportBillsOrgQueryRequest, BuildError> {
        Ok(ExportBillsOrgQueryRequest {
