...
/// Query parameters for ListUsersPaypoint
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListUsersPaypointQueryRequest {
...
impl ListUsersPaypointQueryRequest {
    pub fn builder() -> ListUsersPaypointQueryRequestBuilder {
        <ListUsersPaypointQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListUsersPaypointQueryRequestBuilder {
...
impl ListUsersPaypointQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListUsersPaypointQueryRequest`].
    pub fn build(self) -> Result<ListUsersPaypointQueryRequest, BuildError> {
        Ok(ListUsersPaypointQueryRequest {
