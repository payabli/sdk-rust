...
impl RemoveDeviceResponse {
    pub fn builder() -> RemoveDeviceResponseBuilder {
        <RemoveDeviceResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RemoveDeviceResponseBuilder {
...
impl RemoveDeviceResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`RemoveDeviceResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`payabli_api_response_generic_2_part_fields`](RemoveDeviceResponseBuilder::payabli_api_response_generic_2_part_fields)
    pub fn build(self) -> Result<RemoveDeviceResponse, BuildError> {
        Ok(RemoveDeviceResponse {
