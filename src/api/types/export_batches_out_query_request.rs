...
/// Query parameters for ExportBatchesOut
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportBatchesOutQueryRequest {
...
impl ExportBatchesOutQueryRequest {
    pub fn builder() -> ExportBatchesOutQueryRequestBuilder {
        <ExportBatchesOutQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportBatchesOutQueryRequestBuilder {
...
impl ExportBatchesOutQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportBatchesOutQueryRequest`].
    pub fn build(self) -> Result<ExportBatchesOutQueryRequest, BuildError> {
        Ok(ExportBatchesOutQueryRequest {
