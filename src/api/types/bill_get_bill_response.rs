...
impl GetBillResponse {
    pub fn builder() -> GetBillResponseBuilder {
        <GetBillResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetBillResponseBuilder {
    ...
    response_data: Option<BillResponseData>,
}

impl GetBillResponseBuilder {
    ...
    pub fn response_data(mut self, value: BillResponseData) -> Self {
        self.response_data = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`GetBillResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](GetBillResponseBuilder::response_text)
    pub fn build(self) -> Result<GetBillResponse, BuildError> {
        Ok(GetBillResponse {
