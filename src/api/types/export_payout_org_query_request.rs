...
impl ExportPayoutOrgQueryRequest {
    pub fn builder() -> ExportPayoutOrgQueryRequestBuilder {
        <ExportPayoutOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportPayoutOrgQueryRequestBuilder {
...
impl ExportPayoutOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportPayoutOrgQueryRequest`].
    pub fn build(self) -> Result<ExportPayoutOrgQueryRequest, BuildError> {
        Ok(ExportPayoutOrgQueryRequest {
