...
pub struct GetBasicEntryResponse {
...
impl GetBasicEntryResponse {
    pub fn builder() -> GetBasicEntryResponseBuilder {
        <GetBasicEntryResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct GetBasicEntryResponseBuilder {
...
impl GetBasicEntryResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`GetBasicEntryResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`is_success`](GetBasicEntryResponseBuilder::is_success)
    /// - [`response_text`](GetBasicEntryResponseBuilder::response_text)
    pub fn build(self) -> Result<GetBasicEntryResponse, BuildError> {
        Ok(GetBasicEntryResponse {
            is_success: self
                .is_success
