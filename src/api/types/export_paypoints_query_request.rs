...
/// Query parameters for ExportPaypoints
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ExportPaypointsQueryRequest {
...
impl ExportPaypointsQueryRequest {
    pub fn builder() -> ExportPaypointsQueryRequestBuilder {
        <ExportPaypointsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportPaypointsQueryRequestBuilder {
...
impl ExportPaypointsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportPaypointsQueryRequest`].
    pub fn build(self) -> Result<ExportPaypointsQueryRequest, BuildError> {
        Ok(ExportPaypointsQueryRequest {
