...
/// Query parameters for ListLineItems
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListLineItemsQueryRequest {
...
impl ListLineItemsQueryRequest {
    pub fn builder() -> ListLineItemsQueryRequestBuilder {
        <ListLineItemsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListLineItemsQueryRequestBuilder {
...
impl ListLineItemsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListLineItemsQueryRequest`].
    pub fn build(self) -> Result<ListLineItemsQueryRequest, BuildError> {
        Ok(ListLineItemsQueryRequest {
