...
/// Query parameters for ListTransfers
#[derive(Debug, Clone, Serialize, Deserialize, Default, PartialEq)]
pub struct ListTransfersQueryRequest {
...
impl ListTransfersQueryRequest {
    pub fn builder() -> ListTransfersQueryRequestBuilder {
        <ListTransfersQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListTransfersQueryRequestBuilder {
...
impl ListTransfersQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListTransfersQueryRequest`].
    pub fn build(self) -> Result<ListTransfersQueryRequest, BuildError> {
        Ok(ListTransfersQueryRequest {
