...
pub struct ListBatchesQueryRequest {
...
impl ListBatchesQueryRequest {
    pub fn builder() -> ListBatchesQueryRequestBuilder {
        <ListBatchesQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ListBatchesQueryRequestBuilder {
...
impl ListBatchesQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ListBatchesQueryRequest`].
    pub fn build(self) -> Result<ListBatchesQueryRequest, BuildError> {
        Ok(ListBatchesQueryRequest {
