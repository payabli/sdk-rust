...
impl VendorResponseSummary {
    pub fn builder() -> VendorResponseSummaryBuilder {
        <VendorResponseSummaryBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct VendorResponseSummaryBuilder {
...
impl VendorResponseSummaryBuilder {
    ...
    /// Consumes the builder and constructs a [`VendorResponseSummary`].
    pub fn build(self) -> Result<VendorResponseSummary, BuildError> {
        Ok(VendorResponseSummary {
