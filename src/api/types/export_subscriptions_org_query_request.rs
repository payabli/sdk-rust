...
impl ExportSubscriptionsOrgQueryRequest {
    pub fn builder() -> ExportSubscriptionsOrgQueryRequestBuilder {
        <ExportSubscriptionsOrgQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct ExportSubscriptionsOrgQueryRequestBuilder {
...
impl ExportSubscriptionsOrgQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`ExportSubscriptionsOrgQueryRequest`].
    pub fn build(self) -> Result<ExportSubscriptionsOrgQueryRequest, BuildError> {
        Ok(ExportSubscriptionsOrgQueryRequest {
