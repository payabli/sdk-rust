...
impl LogoutUserResponse {
    pub fn builder() -> LogoutUserResponseBuilder {
        <LogoutUserResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct LogoutUserResponseBuilder {
    is_success: Option<IsSuccess>,
    response_text: Option<ResponseText>,
}

impl LogoutUserResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`LogoutUserResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](LogoutUserResponseBuilder::response_text)
    pub fn build(self) -> Result<LogoutUserResponse, BuildError> {
