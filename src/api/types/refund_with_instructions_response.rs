...
pub struct RefundWithInstructionsResponse {
...
impl RefundWithInstructionsResponse {
    pub fn builder() -> RefundWithInstructionsResponseBuilder {
        <RefundWithInstructionsResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RefundWithInstructionsResponseBuilder {
...
impl RefundWithInstructionsResponseBuilder {
    ...
    /// Consumes the builder and constructs a [`RefundWithInstructionsResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](RefundWithInstructionsResponseBuilder::response_text)
    /// - [`is_success`](RefundWithInstructionsResponseBuilder::is_success)
    /// - [`response_data`](RefundWithInstructionsResponseBuilder::response_data)
    pub fn build(self) -> Result<RefundWithInstructionsResponse, BuildError> {
        Ok(RefundWithInstructionsResponse {
            response_text: self
                .response_text
