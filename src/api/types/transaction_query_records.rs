...
pub struct TransactionQueryRecords {
...
impl TransactionQueryRecords {
    pub fn builder() -> TransactionQueryRecordsBuilder {
        <TransactionQueryRecordsBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct TransactionQueryRecordsBuilder {
...
impl TransactionQueryRecordsBuilder {
    ...
    /// Consumes the builder and constructs a [`TransactionQueryRecords`].
    /// This method will fail if any of the following fields are not set:
    /// - [`split_count`](TransactionQueryRecordsBuilder::split_count)
    pub fn build(self) -> Result<TransactionQueryRecords, BuildError> {
        Ok(TransactionQueryRecords {
