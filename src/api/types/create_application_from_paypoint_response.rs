...
pub struct CreateApplicationFromPaypointResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub response_data: Option<CreateApplicationFromPaypointResponseData>,
}

impl CreateApplicationFromPaypointResponse {
    pub fn builder() -> CreateApplicationFromPaypointResponseBuilder {
        <CreateApplicationFromPaypointResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateApplicationFromPaypointResponseBuilder {
    ...
    response_data: Option<CreateApplicationFromPaypointResponseData>,
}

impl CreateApplicationFromPaypointResponseBuilder {
    ...
    pub fn response_data(mut self, value: CreateApplicationFromPaypointResponseData) -> Self {
        self.response_data = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`CreateApplicationFromPaypointResponse`].
    /// This method will fail if any of the following fields are not set:
    /// - [`response_text`](CreateApplicationFromPaypointResponseBuilder::response_text)
    pub fn build(self) -> Result<CreateApplicationFromPaypointResponse, BuildError> {
        Ok(CreateApplicationFromPaypointResponse {
