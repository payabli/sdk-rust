...
impl RefundV2Request {
    pub fn builder() -> RefundV2RequestBuilder {
        <RefundV2RequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct RefundV2RequestBuilder {
    amount: Option<f64>,
...
impl RefundV2RequestBuilder {
    ...
    /// Consumes the builder and constructs a [`RefundV2Request`].
    pub fn build(self) -> Result<RefundV2Request, BuildError> {
        Ok(RefundV2Request {
            amount: self.amount,
